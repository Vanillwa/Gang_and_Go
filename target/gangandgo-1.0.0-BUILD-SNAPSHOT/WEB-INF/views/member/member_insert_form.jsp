...
<script type="text/javascript">
	...
	function password_check(f) {
		...
		re_password_check_alert.innerText = "";
		if(m_pwd == ''){
			...
			if(passwordRegex.test(m_pwd)){
				...
				password_check_alert.innerText = "6~20글자의 비밀번호를 입력하세요.";
				password_check_alert.style.color = 'red';
			}
		}
	}
...
<body>
	...
	<form>
		...
		<div class="item">
			...
			<div class="item_text"><input type="email" class="email_text" name="m_email" id="m_email" placeholder="이메일" required></div>
			<div><button type="button" onclick="check_email()">중복체크</button></div>
		</div>
		<div class="item">
		...
		<div class="item" id="secret_tr" style="display: none">
			<div class="item_img"></div>
			<div class="item_text">
				<input class="mail-check-input" disabled="disabled" oninput="cheee();" placeholder="인증번호" required>
		...
		<div class="item">
			...
			<div class="item_text"><input type="text" class="nickname_text" name="m_nickname" id="m_nickname" placeholder="닉네임" required></div>
			<div><button type="button" onclick="check_nickname()">중복체크</button></div>
		</div>
		<div class="item">
			<div class="item_img"></div>
		...
		<div class="item">
			...
			<div class="item_text"><input type="password" class="pwd_text" name="m_pwd" placeholder="비밀번호" oninput="password_check(this.form)" required></div>
		</div>
		<div class="item">
			<div class="item_img"></div>
		...
		<div class="item">
			<div class="item_img"><i class="fa-solid fa-lock"></i></div>
			<div class="item_text"><input type="password" class="repwd_text" name="re_pwd" placeholder="비밀번호 확인" oninput="re_password_check(this.form)" required></div>
		</div>
		<div class="item">
			<div class="item_img"></div>
